...
# Coding Test: Kopo Kopo Pricing Service Assessment Test


Thank you for taking the time to complete our coding test. Your challenge is to
recreate a hypothetical version of an internal pricing service. 
...
All monetary values in the `pricing.json` file are in shillings (Kenya Shillings, `KES`).
The calculated results should be in Kenya Shillings too.
Any rounding should use standard arithmetic rounding to the nearest shilling.


## Going international

In this hypothetical universe we have decided to launch the service overseas. We 
...
answers to the following questions (make sure you answer these questions!):

1. What command(s) do we run to install and start your server?
2. Does your solution actually run?
3. Did you write any tests ?
4. If you had more time, what improvements would you make if any?
5. What bits did you find the toughest? What bit are you most proud of? In both
   cases, why?
6. What one thing could we do to improve this test?
